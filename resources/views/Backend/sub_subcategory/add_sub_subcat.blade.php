...
<div class="row">
    <div class="col-md-6">
       <h3 class="py-3 text-center">Add Sub SubCategory:</h2>

    <form method="post" action="{{route('store.sub.subcategory')}}">
      @csrf
...
<div class="controls">
  <input  type="text"  name="sub_subcategory_name"  class="form-control" placeholder="Sub subCategory name "  > 
