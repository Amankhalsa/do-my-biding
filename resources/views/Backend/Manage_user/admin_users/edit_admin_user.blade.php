...
<div class="container rounded bg-white mb-5">
    <div class="row">
        ...
        <div class="col-md-6 border-right">
            ...
            @csrf
              <input type="hidden" name="old_image" value="{{$get_admin_users->profile_photo_path}}">
            <div class="p-3 py-5">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="text-right">Edit Admin Profile Settings</h4>
                </div>
                <div class="row mt-2">
                    <!-- name -->
                    <div class="col-md-6"><label class="labels required">Name</label>
                        <input type="text" class="form-control" name="name" value="{{$get_admin_users->name}}" >
                        @error('name')
                    ...
                    <!-- email -->
                        <input type="email" name="email" class="form-control" value="{{$get_admin_users->email}}" >
                        @error('email')
                        <span class="text-danger"> {{$message}}</span>
                        @enderror
                    </div>
