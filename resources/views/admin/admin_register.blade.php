...
<input type="email" class="form-control" name="email"  autocomplete="email" placeholder="Email Address">
...
<button type="submit" class="btn btn-blue">Signup</button>
                        ...
                        <div class="footer">
                            <p>Copyright &copy; {{date('Y')}} <a href="https://domybidding">Domybiding</a>. All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div><!--/ content wrapper -->
